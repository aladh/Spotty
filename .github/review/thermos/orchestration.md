...
Run the two thermo review passes as foreground native tasks in parallel, then synthesize their results.
...
3. Launch both subagents in the same message as foreground native tasks:
   - `subagent_type: "thermos-correctness"` for bugs, breakages, security, devex regressions, feature-flag leaks, and other branch-audit risks.
