Build toward [Spotty's purpose](docs/product/scope.md#why-spotty). Prioritize
account/privacy/session safety, playback and lifetime correctness, then truthful state,
...
- Spotty is maintained exclusively by agents. Finish authorized work and relevant verification;
  report blockers and unverified behavior.
