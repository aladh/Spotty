...
and approves when no actionable findings remain. The [documentation review](docs/development/docs-review.md)
does the same for PRs that touch documentation, and additionally requires that any change to a
product contract, repository rule, or historical record be declared in the PR description.
