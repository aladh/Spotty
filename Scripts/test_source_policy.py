...
class SourcePolicyRoutingTests(unittest.TestCase):
    ...
    def test_new_boundaries_and_owner_exceptions(self):
        cases = [
            ...
            ("Sources/SpottyEngineAdapter/New.swift", "PlaybackCore.pause()", {"adapter-core-caller"}),
            ("Sources/SpottyEngineAdapter/RustPlaybackEngine.swift", "PlaybackCore.pause()", set()),
            ("Sources/SpottyEngineAdapter/PlaybackCore.swift", "spotty_playback_pause()", set()),
