//
//  PlaybackSessionRuntime+Queue.swift
//  Spotty
//
...
extension PlaybackSessionRuntime {
    ...
    package func addToQueue(uris: [String]) {
    ...
    package func canRemoveUpcomingQueue(selectedIDs: Set<String>) -> Bool {
    ...
    package func refreshQueueSnapshot() {
    ...
    package func cancelQueueRefresh() {
