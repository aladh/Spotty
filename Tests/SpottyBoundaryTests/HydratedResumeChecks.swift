...
struct HydratedResumeTests {
    ...
    private func playback(revision: UInt64, uri: String, playing: Bool, positionMS: Int64 = 152_000)
        -> RustPlaybackState
    {
        RustPlaybackState(
    ...
    private func hydratedPlayer(engine: HarnessEngine) async -> PlaybackStore {
