...
struct PlaybackReducerTests {
    @Test
    func staleAccountAndEngineEpochsAreRejected() {
    ...
    @Test
    func sourceRevisionsAdvanceOnlyForward() {
    ...
    @Test
    func acceptanceQueriesDoNotRecordRevisionsOrEpochs() {
        var state = PlaybackState(accountEpoch: 1, engineEpoch: 1, session: .ready)
        _ = PlaybackReducer.reduce(
            &state,
            envelope: envelope(
    ...
    @Test
    func aRestartedEngineEpochAdoptsItsOwnDeviceRevision() {
        var state = PlaybackState(accountEpoch: 1, engineEpoch: 1, session: .ready)
        state.devices = PlaybackDeviceSnapshot(
            devices: [PlaybackDevice(id: "old", name: "Old", type: "computer")],
            localDeviceID: "old",
    ...
    @Test
    func pendingTransportCommandsPresentOptimisticallyUntilSettled() {
    ...
    @Test
    func rejectedOptionsAcknowledgementsClearTheirCommand() {
    ...
    @Test
    func remotePauseRetainsOwnerAndNowPlayingMetadata() {
    ...
    @Test
    func ownerResolutionFallsBackWhenNoTrackIsPlaying() {
    ...
    @Test
    func connectionSnapshotsChangeSessionAndOwnerTogether() {
    ...
    @Test
    func onePresentationEventInstallsTrackTransportAndTiming() {
    ...
    @Test
    func positionRefreshesFollowAccountAndEngineLifetime() {
        var state = PlaybackState(
            accountEpoch: 2,
            engineEpoch: 3,
            session: .ready,
    ...
    @Test
    func exactQueuesOutrankProvisionalOnes() {
        var state = PlaybackState(accountEpoch: 1, engineEpoch: 1, session: .ready)
    ...
    @Test
    func resetKeepsEpochsAndInstallsTheRequestedSession() {
