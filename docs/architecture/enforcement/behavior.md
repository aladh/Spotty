...
| `TST-PLM-001`, `TST-FBK-001` | Playlist writes stay behind mutation owners; transient mutation feedback stays out of playback state | ADR 002, [playlists](../../product/playlists.md), and [transient feedback](../../product/navigation.md#transient-mutation-feedback) | Playlist/editability and transient-feedback suites |
...
| `TST-FIX-001` | Fixtures are reduced, synthetic, and non-identifying | [Privacy](../../../PRIVACY.md) and [test guidance](../../../Tests/AGENTS.md) | Fixture contract suite plus semantic privacy review |
...
| `TST-GATE-001` | The complete gate runs every discovered Swift test in both targets; repeat count is bounded to 1–25 | [Build and verification](../../development/verification.md) | `Scripts/check.sh` test filtering/repeat behavior |
