...
| `SRC-UI-001` | Fixed dark appearance has one owner and shipping code does not add appearance-mode branching | `Scripts/check.sh` plus [product scope](../../product/scope.md) |
...
| `SRC-DUP-004` | View code does not introduce the intentionally unsupported drag APIs | `Scripts/check.sh` and [playlist behavior](../../product/playlists.md) |
