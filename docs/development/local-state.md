...
- `.build/connect-device-id` — nonsecret Debug Connect identity, stable per checkout; preserve it
  across rebuilds. Debug bundles embed this value and do not use the installed app’s identity.
