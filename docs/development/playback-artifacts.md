...
do not trigger candidate builds for unrelated PRs. Rust checks run on main and on PRs with engine, shared-header, CI, script, license, or unknown-path changes.
