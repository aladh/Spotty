...
Release compilation. The Linux source-policy job classifies PR changes using the base commit's
policy before scheduling Rust. A base without the policy requires Rust conservatively.
