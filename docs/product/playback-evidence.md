...
| Removing selected upcoming occurrences preserves duplicates and protocol metadata; incomplete, restricted or stale evidence fails closed. | [Mutation policy](../../Tests/SpottyDomainTests/QueueMutationChecks.swift), [management boundary checks](../../Tests/SpottyBoundaryTests/QueueManagementChecks.swift), [gateway encoding checks](../../Tests/SpottyGatewayTests/SpotifyConnectEncodingChecks.swift), and [intent occurrence-count checks](../../Tests/SpottyDomainTests/PlaybackIntentChecks.swift). | Local-owner removal remains unsupported. Real queue mutations need explicit authorization; ordinary gates do not perform them. |
